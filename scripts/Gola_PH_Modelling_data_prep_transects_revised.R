...
#### script written by Filibert Heim, filibert.heim@rspb.org.uk or filibert.heim@posteo.de, in Feb 2025, doublechecked in May 2025
...
pres_transects <- read_excel(path = 'data/combined_PH_data2025_draft10.xlsx', sheet = 'combined_transect_data')
locs_transects <- read_excel(path = 'data/combined_PH_data2025_draft10.xlsx', sheet = 'locations_transects') %>% 
...
# check for correct crs to avoid issues 
